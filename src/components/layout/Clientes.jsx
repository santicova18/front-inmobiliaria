  ...
  return (
    <div className="p-6 max-w-6xl mx-auto bg-gray-50 min-h-screen">
      ...
      <div className="grid grid-cols-3 gap-4 mb-6">
       ...
       <StatCard label="Cuentas activas" value={clientes.filter(c => c.activo).length} icon="◈" color="teal" />
       <StatCard label="Verificados" value={clientes.filter(c => c.is_verified).length} icon="●" color="blue" />
       </div>
